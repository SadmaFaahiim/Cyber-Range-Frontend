export const APP_STRINGS = {
  ...
  BUILDER: {
    ...
    MISSING_OS: 'Please choose an operating system for all computers before continuing to review.',
    CABLE_IN_PROGRESS: 'Drag the cable ends onto a port to connect it.',
    CABLE_CANCEL: 'Cancel Cable',
  },
  PALETTE: {
    TITLE: 'Components',
    DRAG_HINT: 'Drag onto canvas',
    CABLE_HINT: 'Drag or click to place',
  },
  PROPERTIES: {
    TITLE: 'Properties',
